...
def test_ranking():
    ...
    shops = [
        ...
        },
        {
            "id": "2",
            "name": "Shop B",
            "coords": {"lat": 10.7800, "lng": 106.7000},
            "price": 150000,
            "rating": 3.0,
        },
        {
            "id": "3",
            "name": "Shop C",
            "coords": {"lat": 10.7750, "lng": 106.6950},
            "price": 80000,
            "rating": 4.8,
        },
    ]
...
def test_tsp_pipeline():
    ...
    shops = [
        ...
        },
        {
            "id": "3",
            "name": "Điểm 3",
            "coords": {"lat": 10.775, "lng": 106.695},
            "price": 70000,
            "rating": 3.8,
        },
    ]
    ordered, metrics, route_geometry = run_tsp_pipeline(
        shops, user_lat=10.772, user_lon=106.698
    )
    ...
    request = OptimizeRequest(
        ...
        shops=[
            ShopItem(
                ...
                coords=ShopCoords(lat=10.7720, lng=106.6983),
                price=85000,
                rating=4.6,
            ),
            ShopItem(
                id="tour_2",
                name="Café Sài Gòn Heritage",
                coords=ShopCoords(lat=10.7780, lng=106.7020),
                price=120000,
                rating=4.2,
            ),
            ShopItem(
                id="tour_3",
                name="Áo Dài Phương",
                coords=ShopCoords(lat=10.7750, lng=106.6950),
                price=350000,
                rating=4.8,
            ),
            ShopItem(
                id="tour_4",
                name="Bến Thành Souvenir",
                coords=ShopCoords(lat=10.7725, lng=106.6980),
                price=65000,
                rating=3.9,
            ),
            ShopItem(
                id="tour_5",
                name="Lụa Tơ Tằm Artisan",
                coords=ShopCoords(lat=10.7700, lng=106.7010),
                price=280000,
                rating=4.5,
            ),
        ],
